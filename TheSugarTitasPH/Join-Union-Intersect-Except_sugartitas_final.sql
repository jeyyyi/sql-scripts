...
-- 2. List all the records of those customers who did not ordered in the month of January 2019
SELECT *
FROM customer
...
-- Customers who haven't ordered anything yet can appear on the list. Sort the records by Customer_ID.
SELECT *
FROM Customer
